...
<body>
	...
	<h1>Editar registro de un paciente</h1>
	<center><h2>Haga clik en el icono verde del paciente para editar el registro.</h2></center>
    		...
    		while ($fila=mysqli_fetch_array ($query)){
      		?>
				<tr>
			      ...
			      <td><a class="btn btn-outline-success"  href="../paginas/formEditarPacientes.php?clave=<?php echo $fila ['clave']?>&accion=editar1"><i class="fa fa-pencil-square-o"></i></a></td>
				</tr>
			</tbody> 
			<?php }
			mysqli_close($con);?>  
